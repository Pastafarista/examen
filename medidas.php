<?php
	// Ejemplo de conexión y consulta a base de datos MySQL con PHP.
	//
	...
	// se quiere trabajar
	$usuario = "admin";
	$password = "Minecrafte0";
	$servidor = "messtech.cihtvbka6sl4.us-east-1.rds.amazonaws.com";
	$basededatos = "BD-medidas";
    $tabla = "Medidas";
	...
	echo "<table borde='2'>";
	echo "<tr>";
	echo "<th>id_medida</th>";
	echo "<th>fecha_y_hora</th>";
	echo "<th>valor</th>";
	echo "<th>unidad</th>";
	echo "</tr>";
	...
	{
		echo "<tr>";
        echo "<td>" . $columna['id_medida'] . "</td><td>" . $columna['fecha_y_hora'] . "</td><td>" . $columna['valor'] . "</td><td>". $columna['unidad'] . "</td>";
		echo "</tr>";
	}
